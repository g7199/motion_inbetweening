...
def sample_motion_while_training(model, scheduler, mean, std, device, output_path, template_path, condition_pos, traj_mean, traj_std, clip_length=180, feature_dim=212, guidance_scale=3.0, ):
    model.eval()
